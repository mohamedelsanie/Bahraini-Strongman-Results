<x-admin-layout>
                ...
                <div class="col-md-6 col-sm-12">
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('admin/game.edit.edit') }}<code>{{ $data->name }}</code></li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="clearfix mb-10">
                    <div class="pull-left">
                        <h4 class="text-blue h4">{{ __('admin/game.edit.edit') }} </h4>
                    </div>
                </div>
                <div class="dropdown-divider"></div>

                <form action="{{ route('admin.games.update', $data->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12 col-md-12 mb-30">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input name="name" placeholder="{{ __('admin/game.fields.name') }}" value="{{ $data->name }}" class="border-gray-300 rounded-md shadow-sm form-control @error('name') border border-danger @enderror" type="text"/>
                            ...
                            <div class="card card-box custom mb-10" id="accordionWork">
                                ...
                                <div id="collapseWork" class="card-body show" data-parent="#accordionWork" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            ...
                                            <div class="custom-control custom-radio mb-5">
                                                <input type="radio" id="qualifiers" name="level" value="qualifiers" class="custom-control-input" @if($data->level == 'qualifiers') checked @endif />
                                                <label class="custom-control-label" for="qualifiers">{{ __('admin/game.fields.qualifiers') }}</label>
                                            </div>
                                            <div class="custom-control custom-radio mb-5">
                                                <input type="radio" id="standard" name="level" value="standard" class="custom-control-input" @if($data->level == 'standard') checked @endif />
                                    ...
                                    <div class="form-group row tries @if($data->level != 'qualifiers') hidden @endif">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/game.fields.tries') }}</label>
                                        <div class="col-sm-12 col-md-12">
                                            <input name="tries" placeholder="{{ __('admin/game.fields.tries') }}" value="{{ $data->tries }}" class="border-gray-300 rounded-md shadow-sm form-control @error('tries') border border-danger @enderror" type="text"/>
                                            @error('tries')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                    </div>

                                    <div class="form-group row type @if($data->level != 'standard') hidden @endif">
                                        <label class="col-sm-12 col-md-12 col-form-label">{{ __('admin/game.fields.type') }}</label>
                                        <div class="col-sm-12 col-md-12">

                                            <div class="custom-control custom-radio mb-5">
                                                <input type="radio" id="repetition" name="type" value="repetition" class="custom-control-input" @if($data->type == 'repetition') checked @endif />
                                                <label class="custom-control-label" for="repetition">{{ __('admin/game.fields.repetition') }}</label>
                                            </div>
                                            <div class="custom-control custom-radio mb-5">
                                                <input type="radio" id="distance" name="type" value="distance" class="custom-control-input" @if($data->type == 'distance') checked @endif />
                        ...
                        <div class="col-sm-12 col-md-10">
                            <button class="btn btn-primary bg-gray-800" type="submit">{{ __('admin/game.fields.update') }}</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    @endsection
    @section('page_title'){{  __('admin/game.edit.title_tag',['name' => $data->name]) }}@endsection
</x-admin-layout>

<x-admin-layout>
        ...
        <div class="page-header mb-0">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    ...
                    <a href="{{ route('admin.games.create') }}" class="btn btn-primary btn-sm scroll-click"><i class="fa fa-plus"></i> {{ __('admin/game.index.create') }}</a>
                    @endif
                    @if(AdminCan('user-forcedelete'))
                    <a href="{{ route('admin.games.archive') }}" class="btn btn-primary btn-sm scroll-click">{{ __('admin/game.index.archive') }}</a>
                    @endif
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="clearfix mb-10">
                            <div class="pull-left">
                                <h4 class="text-blue h4">{{ __('admin/game.index.title') }}</h4>
                            </div>
                        </div>
    ...
    @section('page_title'){{ __('admin/game.index.title_tag') }}@endsection
</x-admin-layout>

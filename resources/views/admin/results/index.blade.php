                        ...
                        <div class="card card-box text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-20">
                                    {{ __('admin/result.index.light_desc') }}
                                </p>
                                <a href="{{ route('admin.results.category',['slug' => 'light']) }}" class="btn btn-primary">{{ __('admin/result.index.light_button') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4 mb-30 mt-30">
                        <div class="card card-box text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-20">
                                    {{ __('admin/result.index.medium_desc') }}
                                </p>
                                <a href="{{ route('admin.results.category',['slug' => 'medium']) }}" class="btn btn-primary">{{ __('admin/result.index.medium_button') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4 mb-30 mt-30">
                        <div class="card card-box text-center">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-20">
                                    {{ __('admin/result.index.strongest_desc') }}
                                </p>
                                <a href="{{ route('admin.results.category',['slug' => 'strongest']) }}" class="btn btn-primary">{{ __('admin/result.index.strongest_button') }}</a>
                            </div>
                        </div>
                    </div>
                </div>

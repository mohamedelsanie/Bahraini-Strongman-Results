        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                        ...
                        <div class="clearfix mb-10">
                            <div class="pull-left">
                                <h4 class="text-blue h4">
                                    ...
                                    @endif
                                        {{ __('admin/result.index.game_title').$game->name }}
                                </h4>
                            </div>
                        </div>
                ...
                <table class="table table nowrap table-bordered table-striped no-footer dtr-inline" id="results-table">
                    ...
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">{{ __('admin/common.table.result_game_player_name') }}</th>
                        <th scope="col">{{ __('admin/common.table.result_game_player_num') }}</th>
                        <th scope="col">{{ __('admin/common.table.result_game_player_wieght') }}</th>
                        <th scope="col">{{ __('admin/common.table.result_game_player_result') }}</th>
                        <th scope="col">{{ __('admin/common.table.result_game_player_points') }}</th>
                    </tr>
                    </thead>
                    <tbody>
    ...
    <script type="text/javascript">
        $(function() {
            var table = $('#results-table').DataTable({
                ...
                serverSide: true,
                @if(!empty($slug))
                ajax: "{{ Route('admin.game.results.all',['slug' => $slug,'id' => $game->id]) }}",
                @else
